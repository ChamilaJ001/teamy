                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing Support for Teams</span>
                                ...
                                <TextEffect
                                    ...
                                    Modern Solutions for Teams Collaboration
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    We are a team of developers who are passionate about creating modern solutions for teams collaboration.
                                </TextEffect>
                            ...
                            <div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    ...
                                    <Image
                                        ...
                                        src="/images/screenshot-white.png"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
